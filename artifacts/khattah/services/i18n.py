...
CATALOG = {
    ...
    "ar": {
        ...
        "Administrator account": "حساب مسؤول",
        ...
        "Configure amounts, currencies, qualifying counts, rewards, and future availability.": "اضبط المبالغ والعملات وعدد المؤهلين والمكافآت والتوفر المستقبلي.",
        "Open Packages": "فتح الباقات",
        "Configure future Packages without changing completed Package history.": "اضبط الباقات المستقبلية دون تغيير سجل الباقات المكتملة.",
        "Permanent history": "السجل الدائم",
        "Every member Package stores a configuration snapshot when it is created. Later edits apply only to future Packages.": "تحفظ كل باقة عضو نسخة من إعداداتها عند إنشائها. تنطبق التعديلات اللاحقة على الباقات المستقبلية فقط.",
        "Add a package": "إضافة باقة",
        "New package configuration": "إعداد باقة جديدة",
        "Package level": "مستوى الباقة",
        "Display order": "ترتيب العرض",
        "English name": "الاسم بالإنجليزية",
        "Arabic name": "الاسم بالعربية",
        "Package amount": "مبلغ الباقة",
        "Currency": "العملة",
        "Required qualifying participants": "عدد المشاركين المؤهلين المطلوب",
        "Reward amount": "مبلغ المكافأة",
        "Reward currency": "عملة المكافأة",
        "Reward configuration": "إعداد المكافأة",
        "Active for future Packages": "نشطة للباقات المستقبلية",
        "Add package": "إضافة الباقة",
        "Reward": "المكافأة",
        "Historical": "تاريخي",
        "Package status/history": "حالة وسجل الباقات",
        "Package configuration saved. Existing Package history was not changed.": "تم حفظ إعداد الباقة دون تغيير سجل الباقات الحالي.",
        "qualifying positions": "مواضع مؤهلة",
        "Qualifying target": "هدف التأهل",
        "Each package has its own ID, configured qualifying positions, and permanent history.": "لكل باقة معرّف خاص ومواضع تأهل مضبوطة وسجل دائم.",
        "A package completes when its configured number of paid, qualified participants is reached.": "تكتمل الباقة عند بلوغ العدد المضبوط من المشاركين المدفوعين والمؤهلين.",
        "Paid and qualified participants complete this package when its configured target is reached. Completion is event-driven, never monthly.": "يكمل المشاركون المدفوعون والمؤهلون هذه الباقة عند بلوغ هدفها المضبوط. الإكمال قائم على الأحداث وليس شهرياً.",
        "A reward becomes available when a package reaches its configured qualifying count. No money is sent automatically.": "تتوفر المكافأة عند بلوغ الباقة عدد المؤهلين المضبوط. لا تُرسل الأموال تلقائياً.",
        "Complete all configured qualifying positions in a package to create a reward eligibility record.": "أكمل جميع مواضع التأهل المضبوطة في الباقة لإنشاء سجل أهلية المكافأة.",
        "Configured amounts are informational. Payment and payout processing remain disabled.": "المبالغ المضبوطة معلوماتية فقط. تظل معالجة الدفع والصرف معطلة.",
        "Paid / activated participants fill the configured qualifying positions in this package.": "يملأ المشاركون المدفوعون أو المفعّلون مواضع التأهل المضبوطة في هذه الباقة.",
        "Rewards": "المكافآت",
        "Action": "الإجراء",
        "Status": "الحالة",
        "Participant": "المشارك",
        ...
        "Establish member account": "إنشاء حساب العضو",
